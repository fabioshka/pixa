  ...
  <div id="header2">
   ...
   <div id="clear"></div><!--Ende clear-->
    ...
    foreach ($conn->query($sql) as $row) {
       ...
       <div id="bild_wrapper">
	   <form action="foto.php" method="post" enctype="multipart/form-data" width="100%">
      <button type ="submit" class="button" name="link" value="<?php echo $row['link']?>"><img class="buttonpic" src="<?php echo $row['link']; ?>" alt="<?php echo $row['name']; ?>"></button>
